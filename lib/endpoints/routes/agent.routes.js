...
const { agentController, linkController } = require("../controllers");
...
router
	.route("/stl/report")
	.get(authMiddleware.agentAuthMiddleware, inputValidator(agentValidation.stlReport), agentController.stlReport);

 ...
 * @returns
 */
async function getSetting(type, chain) {
    const thisSettingFee = await Settings.findOne({
        where: {
    ...
    const thisSettingAddress = await Settings.findOne({
        where: {
